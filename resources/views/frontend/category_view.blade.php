...
<section class="page-header">
    <div class="container-xl">
        <div class="text-center">
            <h1 class="mt-0 mb-2">{{ $data->title }}</h1>
...
<section class="main-content">
    <div class="container-xl">
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-8">
                <div class="row gy-4">
             @forelse ($post as $s_post)

                <div class="col-sm-6">
                    <!-- post -->
                    <div class="post post-grid rounded bordered">
                        <div class="thumb top-rounded">
                            <a href="category.html" class="category-badge position-absolute">  @if ($s_post->type)
                                {{ $s_post->type }}
                            @endif</a>
                        ...
                        <div class="details">
                            <ul class="meta list-inline mb-0">
                                <li class="list-inline-item"><a href="category.html#"><img src="https://api.dicebear.com/5.x/bottts/svg?size=32&seed=happy" class="author" alt="author"/>{{ $s_post->user->name }}</a></li>
                                <li class="list-inline-item">{{ Carbon\Carbon::parse($s_post->create_at)->diffForHumans(); }}</li>
                            </ul>
